...
funding_links='<section class="phd-programmes" aria-labelledby="phd-programmes-title"><h3 id="phd-programmes-title">PhD programmes &amp; funding</h3><ul>'+''.join(f'<li><a href="{e(p["url"])}"><span><strong>{e(p["name"])}</strong><span class="programme-description">{e(p["description"])}</span></span><span class="programme-arrow" aria-hidden="true">↗</span></a></li>' for p in D['phd_programmes'])+'</ul><p class="programme-note">Explore these routes with Changjian. See each programme’s website for current application dates, eligibility and funding details.</p></section>'
...
join+=f'''<section class="join-layout"><div><div class="opportunity"><span class="number">01</span><div><h2>Doctoral research</h2><p>Explore a PhD at the intersection of computer graphics and computer vision. Contact Changjian with your CV and a short introduction to your interests.</p>{funding_links}</div></div><div class="opportunity"><span class="number">02</span><div><h2>Research & visiting students</h2><p>We welcome enquiries about MSc by Research, visiting research and internships. Tell us about your background, the questions you want to explore and your proposed dates.</p></div></div></div><aside class="contact-panel"><p class="eyebrow">Start a conversation</p><h2>Say hello.</h2><a class="email" href="mailto:Changjian.li@ed.ac.uk">Changjian.li@ed.ac.uk ↗</a><p>Include your CV and a brief description of your research interests.</p><hr><p class="eyebrow">Find us</p><address>Informatics Forum<br>10 Crichton Street<br>Edinburgh, EH8 9AB<br>United Kingdom</address><a class="text-link" href="https://enigma-li.github.io/">PI homepage & current opportunities ↗</a></aside></section>'''
