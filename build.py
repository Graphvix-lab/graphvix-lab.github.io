...
funding_links='<details class="phd-programmes"><summary>PhD programmes &amp; funding<span class="expand-mark" aria-hidden="true">+</span></summary><ul>'+''.join(f'<li><a href="{e(p["url"])}"><span><strong>{e(p["name"])}</strong><span class="programme-description">{e(p["description"])}</span></span><span class="programme-arrow" aria-hidden="true">↗</span></a></li>' for p in D['phd_programmes'])+'</ul><p class="programme-note">Explore these routes with Changjian. See each programme’s website for current application dates, eligibility and funding details.</p></details>'
